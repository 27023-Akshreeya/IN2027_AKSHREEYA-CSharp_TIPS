...
public class ExpenseTrackerViewer
{
    ...
    /// <summary>
    /// prompts user for operation selection
    /// </summary>
    ...
    /// <summary>
    /// executes menu operation
    /// </summary>
    /// <param name="choice">gets users choice as input</param>
    private void ExecuteMenuAction(MenuChoices choice)
    {
        switch (choice)
        {
            ...
            case MenuChoices.ViewAllTransaction:
                if (this.GetDisplayDetails() == RecordChoices.None)
                {
