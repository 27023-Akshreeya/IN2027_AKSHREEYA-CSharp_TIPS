...
public class ExpenseTrackerService
{
    ...
    public bool DeleteRecordTransaction(Guid deleteRecordId, RecordChoices recordChoice)
    {
        ...
        var deleteRecord = this.GetRecordByTransactionID(deleteRecordId, recordChoice);
        decimal netBalance = this._repo.GetNetBalance();
        if (deleteRecord is Income deleteIncomeRecord && deleteIncomeRecord != null)
        {
        ...
        else if (deleteRecord is Expense deleteExpenseRecord && deleteExpenseRecord != null)
        {
    ...
    {
        return record == RecordChoices.IncomeRecords ? this._repo.GetIncome().FirstOrDefault(x => x.TransactionID == transactionID) :
            this._repo.GetExpense().FirstOrDefault(x => x.TransactionID == transactionID);
    }
