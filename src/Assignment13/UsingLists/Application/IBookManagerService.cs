...
/// <typeparam name="TValue">The type of the book's lookup identifier.</typeparam>
public interface IBookManagerService<TEntity, TValue>
    where TEntity : class
{
    /// <summary>
    /// Creates a new book.
    ...
    bool DoesBookExists(TValue value);
